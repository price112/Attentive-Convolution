...
def main(args):
    ...
    # Setup data:
    train_dataset = CustomDataset(data_dir="mlgb", lmdb_path=args.data_dir)
    ...
    progress_bar = tqdm(
        ...
        dynamic_ncols=True,
        miniters=1,  # 每步都尝试刷新，由时间来限频
        mininterval=20.0,  # 两次刷新至少间隔 20 秒
        maxinterval=20.0,  # 最长 20 秒强制一次刷新
    )
...
def parse_args(input_args=None):
    ...
    parser.add_argument("--learning-rate", type=float, default=1e-4)  # keep first
